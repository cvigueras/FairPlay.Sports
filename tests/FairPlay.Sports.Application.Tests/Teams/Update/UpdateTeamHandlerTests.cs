...
public class UpdateTeamHandlerTests
{
    ...
    public async Task Handle_WhenTeamExists_MutatesTheTrackedAggregate_AndReturnsDto()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(team.Colors!.ShortsColor, Is.EqualTo(TeamMother.ShortsColor));
            Assert.That(team.Colors!.Pattern, Is.EqualTo(TeamMother.KitPattern));
            Assert.That(team.AlternateColors!.Primary, Is.EqualTo(TeamMother.AlternateColorPrimary));
            Assert.That(team.AlternateColors!.ShortsColor, Is.EqualTo(TeamMother.AlternateShortsColor));
            Assert.That(team.AlternateColors!.Pattern, Is.EqualTo(TeamMother.AlternateKitPattern));

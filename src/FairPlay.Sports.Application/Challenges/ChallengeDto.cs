...
public sealed record ChallengeDto(
    ...
    AgeCategory ChallengerTeamCategory,
    Division? ChallengerTeamDivision,
    Guid ChallengedTeamId,
    string ChallengedTeamName,
    bool ChallengedTeamHasCrest,
    AgeCategory ChallengedTeamCategory,
    Division? ChallengedTeamDivision,
    Guid HomeTeamId,
    Guid AwayTeamId,
    DateTime MatchDate,
    string? VenueName,
    ...
    DateTime? RespondedAt)
{
    ...
    public static ChallengeDto FromDomain(Challenge challenge, Team challengerTeam, Team challengedTeam)
    {
        ...
        return new(
            ...
            challengerTeam.Classification.Category,
            challengerTeam.Classification.Division,
            challenge.ChallengedTeamId,
            challengedTeam.Name,
            challengedTeam.HasCrest,
            challengedTeam.Classification.Category,
            challengedTeam.Classification.Division,

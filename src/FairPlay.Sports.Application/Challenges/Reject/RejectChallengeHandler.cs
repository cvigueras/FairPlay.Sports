...
public sealed class RejectChallengeHandler(
    IChallengeRepository challenges,
    ITeamRepository teams,
    ITeamMemberRepository teamMembers,
    IClock clock) : IRequestHandler<RejectChallengeCommand, Result<ChallengeDto>>
{
    ...
    public async Task<Result<ChallengeDto>> Handle(RejectChallengeCommand request, CancellationToken cancellationToken)
    {
        ...
        challenge.Reject(_clock.UtcNow);

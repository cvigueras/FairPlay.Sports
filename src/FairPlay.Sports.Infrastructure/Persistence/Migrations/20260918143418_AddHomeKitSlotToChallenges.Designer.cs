...
namespace FairPlay.Sports.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260918143418_AddHomeKitSlotToChallenges")]
    partial class AddHomeKitSlotToChallenges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FairPlay.Sports.Domain.Challenges.Challenge", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<string>("AwayKitSlot")
                        .HasMaxLength(10)
                    ...
                    b.Property<Guid>("VenueTeamId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("ChallengedTeamId");

                    b.HasIndex("ChallengerTeamId");

                    b.HasIndex("VenueTeamId");
            ...
            modelBuilder.Entity("FairPlay.Sports.Domain.Challenges.Challenge", b =>
                {
                    b.HasOne("FairPlay.Sports.Domain.Teams.Team", null)
                        .WithMany()
                        .HasForeignKey("ChallengedTeamId")
